...
dat %>% 
  group_by(Therapy, AmtTher) %>% 
  rstatix::identify_outliers(Stalker)
```
...
### 8. Report the main effect of Type of Therapy in APA format. Is this effect significant and how would you interpret it?



### 9. Report the main effect of Time in Therapy in APA format. Is this effect significant and how would you interpret it?



### 10. Report the interaction effect between Therapy and AmtTher in APA format. Is this effect significant and how would you interpret it?
